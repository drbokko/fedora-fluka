...
docker build --build-arg fedora_for_fluka_repo=$fedora_for_fluka_repo --build-arg fluka_package=$fluka_package -t fedora_with_fluka_for_${USER_NAME}:$fluka_version.$fluka_respin -t fedora_with_fluka .
